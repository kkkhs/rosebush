...
export var Form = forwardRef(function (_a, ref) {
    var _b = _a.name, name = _b === void 0 ? 'rose_form' : _b, children = _a.children, initialValues = _a.initialValues, onFinish = _a.onFinish, onFinishFailed = _a.onFinishFailed;
    var _c = useStore(initialValues), form = _c.form, fields = _c.fields, dispatch = _c.dispatch, restProps = __rest(_c, ["form", "fields", "dispatch"]);
    ...
    var submitFrom = function (e) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("form", { name: name, className: "rose-form", onSubmit: submitFrom },
