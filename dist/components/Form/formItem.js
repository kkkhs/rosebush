...
var FormItem = function (_a) {
    ...
    var rowClass = classNames('rose-row', {
    ...
    var itemClass = classNames('rose-form-item-control', {
    ...
    if (childrenList.length === 0) {
        console.error('From.Item has no children, please provide at least on children!');
    }
    ...
    return (React.createElement("div", { className: rowClass },
        label && (React.createElement("div", { className: "rose-form-item-label" },
            React.createElement("label", { title: label, className: labelClass }, label))),
        React.createElement("div", { className: "rose-form-item" },
            React.createElement("div", { className: itemClass }, returnChildNode),
            hasError && (React.createElement("div", { className: "rose-form-item-explain" },
