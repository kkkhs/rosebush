...
export var UploadList = function (_a) {
    ...
    return (React.createElement("ul", { className: "rose-upload-list" }, fileList.map(function (item) {
        return (React.createElement("li", { className: "rose-upload-list-item", key: item.uid },
