 ...
 * ~~~
 */
export declare const AutoComplete: ({ fetchSuggestions, onSelect, onChange, value, renderOption, ...restProps }: AutoCompleteProps) => import("react/jsx-runtime").JSX.Element;
